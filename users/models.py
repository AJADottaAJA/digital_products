...
from django.contrib.auth.models import BaseUserManager, AbstractBaseUser, send_mail, PermissionsMixin
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    admin-complian permissions
    username,  password and email are required. other fields are optional
    """
    username = models.CharField(_("username"), max_length=32, unique=True,
                                help_text="Required. 30 characters or fewer starting with a letter. letters, digitals ",
    ...
    phone_number = models.BigIntegerField(_("mobile number"), unique=True, blank=True, null=True,
